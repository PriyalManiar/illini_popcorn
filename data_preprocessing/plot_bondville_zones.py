#!/usr/bin/env python3
"""
Plot Bondville zones as a rectangular grid (county-style map).
Reads bondville_zones.csv, aggregates points into grid cells by majority zone,
...
# UPDATED PATHS: Step out of data_preprocessing/ to find/save files in the root folder
ROOT_DIR = Path(__file__).resolve().parent.parent
CSV_PATH = ROOT_DIR / "bondville_zones.csv"
OUTPUT_PNG = ROOT_DIR / "bondville_zones_map.png"
OUTPUT_HTML = ROOT_DIR / "bondville_zones_map.html"
...
def main():
    ...
    ax.set_title("Bondville zones (rectangular grid)", fontsize=14, fontweight="bold")
    ax.set_aspect("equal")
