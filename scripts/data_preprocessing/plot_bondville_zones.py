...
CSV_PATH = OUTPUTS_DIR / "bondville_zones.csv"
OUTPUT_PNG = OUTPUTS_DIR / "bondville_zones_map.png"
OUTPUT_HTML = OUTPUTS_DIR / "bondville_zones_map.html"
...
def main():
    ...
    try:
        ...
        ax2.axis("off")
        overlay_png = OUTPUTS_DIR / "bondville_zone_overlay.png"
